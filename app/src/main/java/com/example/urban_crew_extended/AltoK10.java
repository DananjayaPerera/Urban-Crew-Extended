            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    ...
                    case R.id.alto_hour_check:
                        String option_1 = "Hourly";
                        resultBook = option_1;
                        break;


                    case R.id.alto_day_check:
                        String option_2 = "Daily";
                        resultBook = option_2;
                        break;
        ...
        food.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (food.isChecked()){
                    ...
                    altoExtraResult.add("Foods");
                } else {

                    altoExtraResult.remove("Foods");
                }
            }
        });
        ...
        drink.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (drink.isChecked()){
                    ...
                    altoExtraResult.add("Drinks");
                } else {

                    altoExtraResult.remove("Drinks");
                }
            }
        });
